...
public class CartController {
    ...
    @ResponseBody
    public ResponseEntity updateCartItem(@PathVariable(name = "cartItemId") Long cartItemId, int count, Principal principal) {
    ...
    public ResponseEntity orders(@RequestBody CartOrderDto cartOrderDto, Principal principal) {
        ...
        // 장바구니 주문 상품들을 각각 검증
        for (CartOrderDto cod : cartOrderDtoList) {
            if (!cartService.validateCartItem(cod.getCartItemId(), principal.getName())) {
